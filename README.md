...
For example, if one can use a model trained on period doubling and chaotic behavior classes this program could be used to find the rate at which a dripping faucet goes through these stages.
